...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-8 md:-mt-12 mx-auto h-[20rem] md:h-[30rem] lg:h-[40rem] w-full border-2 md:border-4 border-[#6C6C6C] p-1.5 md:p-4 lg:p-6 bg-[#222222] rounded-[20px] md:rounded-[30px] shadow-2xl"
    >
